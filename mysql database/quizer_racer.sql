...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2023. Máj 17. 09:18
...
--
-- Tábla szerkezet ehhez a táblához `log_in_user`
--
...
('73628c71d01865f1176100f279b3d4b90517b51a2f0270355c874104be967af4', 1);
...
(1, 'valamik', 'valamik', 'valamikvalamik@gmail.com', '$2b$10$YsVDHHF2Hcgm4/JJ3gJ2A.B9G9Uf/Xh.JPfwYBB80eFUUK99jX/QC'),
(2, 'asdasd', 'asdasd', 'asdasd@gmail.com', '$2b$10$pH6DkIhTmXaTMga3ebBHVeFpYriYQdz2Nouwin0LSROS/HevJZ/aa');
...
--
-- A tábla indexei `log_in_user`
--
ALTER TABLE `log_in_user`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `REL_76eee6185f50bd30ba0b2efb56` (`signUpId`);
...
--
-- AUTO_INCREMENT a táblához `log_in_user`
--
ALTER TABLE `log_in_user`
...
--
-- Megkötések a táblához `log_in_user`
--
ALTER TABLE `log_in_user`
  ADD CONSTRAINT `FK_76eee6185f50bd30ba0b2efb562` FOREIGN KEY (`signUpId`) REFERENCES `user` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
